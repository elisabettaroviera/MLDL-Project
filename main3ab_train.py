...
if __name__ == "__main__":
    ...
    num_classes = 19
    ignore_index = 255
    start_epoch = 49 #CHECK BEFORE RUNNING
...
"""
    ...
    #type_aug = {'weather': ['RandomFog', 'RandomRain",ISONoise','GaussianBlur'] }#i,l
   ...
   # max_iter = num_epochs * len(full_dataloader_gta_train)
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        project_name = "3b_GTA5_to_CITY_augmented_color_2_random_tranform_color_OR_ALL_g_h_i_100_percent"   # Change here!
...
#DA RUNNARE
#3b_GTA5_to_CITY_augmented_color_2_random_tranforms_color_100_percent

#3b_GTA5_to_CITY_augmented_color_2_random_tranform_color_OR_ALL_g_h_i_100_percent val da 29