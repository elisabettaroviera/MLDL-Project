...
if __name__ == "__main__":
    ...
    # a + d + e
    type_aug = { 'color': ['HueSaturationValue', 'RGBShift', 'RandomBrightnessContrast']} # a+d+e) 3b_GTA5_to_CITY_aug_color_a_d_e_25percent 
    # b + c +cose 
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        project_name = "3b_GTA5_to_CITY_aug_color_a_d_e_25percent" #CHECK BEFORE RUNNING________________________________________HERE
