...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        # _lr_0.00625_ce05_h03_d02_warmup3000_weighted_SGD
        # 
        
        project_name = f"{var_model}_lr_0.00625_ce06_h04_(ONLY)_warmup3000_weighted_SGD" # CHANGE HERE THE PROJECT NAME
        ...
        if epoch != 1:
            ...
            # Defintion of the loss function CombinedLoss_All
            print("Definition of the loss") 
            loss = CombinedLoss_All(num_classes=num_classes, alpha=0.6, beta=0, gamma=0, theta=0, delta=0, epsilon=0.4, focal_gamma=2, ignore_index=255, class_weights=class_weights) # CHANGE HERE THE LOSS
            # alpha   - CrossEntropy
            # beta    - Lovász
            # gamma   - Tversky
            # theta   - Dice
            ...
            print("Definition of the loss") 
            loss = CombinedLoss_All(num_classes=num_classes, alpha=0.6, beta=0, gamma=0, theta=0, delta=0, epsilon=0.4, focal_gamma=2, ignore_index=255)
   ...
   #  ce05 + H05 + tv03 warmup 3000 + lr=0.00625 starting_epoch = 1 WEIGHTED + drop out + all the previous change + ALPHA_1=0.75 + SGD
