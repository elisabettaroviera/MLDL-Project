...
if __name__ == "__main__":
    ...
    # Tutte le combinazioni di 2 lettere ordinate
    all_combs = sorted([tuple(sorted(c)) for c in combinations(dict_augs_w.keys(), 2)])

    for comb in all_combs:
        # Genera il nome del progetto
        project_name = f"3b_GTA5_to_CITY_augmented_weather_{comb[0]}_{comb[1]}_25_percentage"
